...
public class CourseController extends Controller {
    ...
    public void loadDetailView(String course) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("course-details-scene.fxml"));
    ...
    public void loadTeacherView() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("teacher-scene.fxml"));
        Parent root = fxmlLoader.load();
